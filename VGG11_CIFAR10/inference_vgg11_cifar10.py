...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='VGG11 CIFAR10 Evaluation')
    ...
    model.load_state_dict(torch.load('model_state_dict_VGG11_CIFAR10.pth', weights_only=True, map_location=device))
